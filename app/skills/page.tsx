...
export default function SkillsPage() {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      title: "Web & Backend",
      icon: Code,
      description: "Frontend, backend, and API development technologies",
      skills: [
        "Node.js",
        "React",
        "Next.js",
    ...
    },
    {
      ...
      title: "Cloud & DevOps",
      icon: Cloud,
      description: "Cloud platforms, containers, and version control",
      skills: ["GCP", "AWS", "Docker", "Git", "GitHub"],
    },
    {
      id: 5,
      title: "Databases & Tools",
      icon: Database,
      description: "Database and persistence technologies",
      skills: [
        "MySQL",
        "PostgreSQL",
        "MongoDB",
